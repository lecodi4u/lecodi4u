         ...
         <div class="orderDiv">
            <div class="orderer_info">
               ...
               <table class="orderer InfoTable">
                  <tr>
                     ...
                     <td><input value="${Member.name }" type="text" id="orderer_name"
                        name="name" style="height: 100%;"></td>
                  </tr>
                  <tr>
                     <td>이메일 <b style="color: red">*</b>
                     </td>
                     <td><input value="${Member.email_id}" type="text" name="email_id" id="str_email01"
                        style="width: 100px"> @ <input type="text"
                        name="email_domain" id="str_email02" style="width: 100px;"
                        value="${Member.email_domain }"> <select
               ...
               <table class="delivery InfoTable">
                  <tr>
                     ...
                     <td><input type="text" style="width: 100px"
                        class="addressInput" id="postCode" name="postcode">
                        ...
                        id="baseAddress" name="address_primary"> 기본 주소 <br> 
                        <input type="text" style="width: 300px" class="addressInput" name="address_detail"> 상세 주소 <br>
                     </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                     ...
                     <td><input value="${Member.phonenumber1 }" type="text"
                        style="text-align: center; width: 80px;" id="cellphone1"name="phonenumber1">
                         - <input value="${Member.phonenumber2 }" type="text"style="text-align: center; width: 80px;" id="cellphone2"name="phonenumber2"> 
                         - <input value="${Member.phonenumber3 }" type="text" style="text-align: center; width: 80px;" id="cellphone3" name="phonenumber3">
                     </td>
                  </tr>
                  <tr>
                     <td>배송시 요청사항</td>
               ...
               <table class="product_table">
                  ...
                  <c:forEach items="${sessionScope.cartList}" var="cart">
                     <tr>
                        ...
                        <td>
                           <div class="product_name" style="width: 60%; float: left;">${cart.productname}</div>
                        </td>
                        <td class="product_amount">${cart.cartmount}<%-- <%=basket.getP_identifier() %> --%></td>
                        <td class="product_price">${cart.price}</td>
                        <!-- <td class="discount">-</td>
                        <td class="discount_price">10000원</td> -->
                        <fmt:parseNumber var="Amount_accumulated" value="${basket.price * 0.01}" integerOnly="true"/>
                  ...
                  <tr>
                     ...
                     <td>
                        <div id="radioArea">
                           ...
                           <input name="payment_type" type="radio"
                              class="select_payment" value="실시간계좌이체"><label>실시간 계좌이체</label> 
                              <input name="payment_type" type="radio"
            ...
            <input type="hidden" name="index" value="-1">
               <div class="last_Payment">
                  <button type="submit"class="img_btn" onclick="pre_order_check()">주문결제</button>
               </div>
      </form>
      </div>
